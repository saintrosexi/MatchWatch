...
const kpIds = [566, 391772, 4134, 315566, 958722, 335];

async function sleep(ms) { return new Promise(r => setTimeout(r, ms)); }

async function main() {
  console.log('Fetching remaining details...');
  ...
  // Clean up wrong memento
  const finalMovies = movies.filter(m => m.titleRu !== 'Запомни это').concat(newMovies);
