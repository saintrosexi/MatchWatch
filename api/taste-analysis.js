export default async function handler(req, res) {
  ...
  try {
    ...
    const prompt = `Ты — высококлассный, строгий, бескомпромиссный и профессиональный кинокритик. Тебе нужно составить глубокий, детальный и индивидуальный кинематографический отчет по профилю пользователя.
Анализ должен быть развернутым, конкретным (с обязательным цитированием названий фильмов) и полностью лишенным банальных водянистых вводных фраз вроде "Ваши киновкусы — это..." или "Перед нами дивный многогранный список...".
Начинай отчет сразу с дела!
