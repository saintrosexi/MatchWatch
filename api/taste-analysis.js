...
Анализ должен быть написан живым, разговорным, человеческим и абсолютно оригинальным языком, БЕЗ сухих шаблонных фраз и рецензионных клише, чтобы полностью избежать сходства с опубликованными в интернете статьями.
...
4. **АБСОЛЮТНЫЙ ЗАПРЕТ НА ЧУВСТВИТЕЛЬНЫЕ СЛОВА (БЕЗОПАСНОСТЬ)**:
   - В тексте категорически запрещено использовать слова, связанные с насилием, смертью, криминалом и запрещенными веществами. Вместо них используй исключительно безопасные, благородные художественные термины: "драматическая развязка", "сложные жизненные ситуации", "противостояние характеров", "эмоциональная дуэль", "жизненный путь", "авторский стиль", "остросюжетная динамика", "шедевры мирового кино".
5. **Объем и Скорость**: Текст должен быть емким, живым и увлекательным (суммарно в районе 250-350 слов), чтобы генерация проходила мгновенно и без задержек. Каждое предложение должно быть полностью завершенным.
