 ...
 *
 * Четыре при заходе раз в четверть часа — это около четырёхсот в сутки.
 * Больше не нужно: очередь конечна, а каталог пополняется десятками
 * фильмов в день. Гнать быстрее значит выбить дневную квоту за час
 * и весь остаток суток стучаться в стену.
 */
const BATCH = 4;
